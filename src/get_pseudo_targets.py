...
class VQAModelHandler:
    ...
    def _resolve_model_name(self) -> str:
        defaults = {
            CheckModel.qwen2_5_vl_7b_instruct: "/nativemm/share/cpfs/tangwenyue/models/Qwen2.5-VL-7B-Instruct",
        ...
        override_key = f"{self.model_type.name}_path"
        candidate = self.model_path_overrides.get(override_key) or defaults.get(self.model_type)
